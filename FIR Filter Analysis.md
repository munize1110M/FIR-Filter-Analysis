...
- ![[Pasted image 20260330183118.png]]

- ![[Pasted image 20260330183935.png]]
...
- ![[Pasted image 20260330182623.png]]

![[Pasted image 20260324171139.png]]
...
![[Pasted image 20260324170445.png]]
...
![[Pasted image 20260324172508.png]]
...
![[Pasted image 20260324172853.png]]

![[Pasted image 20260324173208.png]]
...
- ![[Pasted image 20260330182648.png]]


## Simulation
- Once again, the simulation output matches the expected response.
- ![[Pasted image 20260330151221.png]]

## Timing Analysis
- Chip Layout
- ![[Pasted image 20260330152830.png]]
- ```
  Timing Report
...
## Power and Resource Utilization
- ![[Pasted image 20260330153448.png]]
...
Slack (MET) :             21146.637ns  (required time - arrival time)
  ...
  ```
## Power and Resource Utilization
- ![[Pasted image 20260330162836.png]]
- ![[Pasted image 20260330162925.png]]
...
## Simulation
- ![[Pasted image 20260330163635.png]]
- 
...
- ![[Pasted image 20260330165347.png]]
...
- ![[Pasted image 20260330165624.png]]
...
## DSP Usage
- Another result that caught my eye was the DSP usage when going from a Three Parallel Filter Design to a Three Parallel Pipelined Version. The DSP slice usage lowers significantly when implementing pipelining. This makes sense as pipelining allows us to re-use DSP slices to achieve the same output.
## Chip Area
